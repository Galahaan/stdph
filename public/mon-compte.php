...
if( isset($_POST['boutValidModifs']) ){
...
<main id='iMain'>
    ...
    <section id='iMCDonneesPerso' class='cSectionContour'>
        ...
        <form method='POST'>
            ...
            <div class='cBoutonOk'>
                <button name='boutValidModifs'>Valider</button>
            </div>
        </form>
    </section>
    ...
    <section id='iMCProcedure' class='cSectionContour'>
        ...
        <ol>
            ...
            <form method='POST'>
                <div class='cBoutonOk'>
                    <button name='boutDdeCode'>demande de code</button>
                </div>
            </form>
            ...
            <form method='POST'>
                ...
                <div class='cBoutonOk'>
                    <button name='boutTestCode'>Valider</button>
                </div>
            </form>
        </ol>
